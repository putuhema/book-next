...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        "absolute hidden group-hover:flex justify-center items-center  h-8 w-8 rounded-full",
        orientation === "horizontal"
    ...
    >
      {scrollSnaps.map((_, idx) => (
        <Button
          ...
          size={size}
          className={cn(
            "w-2 h-2 rounded-full bg-accent-foreground border-none ",
            idx === selectedIndex && "bg-white",
            className,
          )}
          {...props}
        >
